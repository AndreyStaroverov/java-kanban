...
public class HttpTaskServer {
    ...
    private void handleTasks(HttpExchange httpExchange) throws IOException {
        try {
            ...
            switch (requestMethod) {
                case "GET":
                    handleForGET(httpExchange, path);
                    break;
                case "POST":
                    handleForPOST(httpExchange, path);
                    break;
                case "DELETE":
                    handleForDELETE(httpExchange, path);
                    break;
                default:
    ...
    private void handleForGET(HttpExchange httpExchange, String path) throws IOException {
    ...
    private void handleForPOST(HttpExchange httpExchange, String path) throws IOException {
    ...
    private void handleForDELETE(HttpExchange httpExchange, String path) throws IOException {
